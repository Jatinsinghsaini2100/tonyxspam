...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply = "**__TONYxSPAM by SASTA TONY;__** \n\n"
    spamx_reply += "<=======================> \n"
    ...
    spamx_reply += f"**TONYxSPAM Version:** `{__version__}` \n"
    spamx_reply += f"**Python Version:** `{platform.python_version()}` \n"
    spamx_reply += f"**pySASTAxTONY Version:** `{rizoelx_vr}` \n"
    ...
    spamx_reply += "**© @Sasta_TonyStark** || Support: @sastatony"
